...
const poolData: Record<ChainId, Record<string, PoolData>> = {
  [ChainId.MAINNET]: {
    [poolAddresses[ChainId.MAINNET].CURVE_THREE_CRV]: {
      ...
      gaugeAddress: '0x4bBea3ff3b3f2Cdd822cFa1b0aeB174f9b132a9f', // ToDo: Replace with constant.
      inputTokenAddress: '0x6c3F90f043a72FA612cbac8115EE7e52BDe6E490', // ToDo: Replace with constant.
      inputTokenGetLink: 'https://curve.fi/3pool/deposit',
    ...
    [poolAddresses[ChainId.MAINNET].CURVE_REN_CRV]: {
      ...
      gaugeAddress: '0xeEa594DFfCF7F9255283ef4Bc7aeC0A45846cC4f', // ToDo: Replace with constant.
      inputTokenAddress: '0x49849C98ae39Fff122806C06791Fa73784FB3675', // ToDo: Replace with constant.
      inputTokenGetLink: 'https://curve.fi/ren/deposit',
    ...
    [poolAddresses[ChainId.MAINNET].CURVE_STE_CRV]: {
      ...
      gaugeAddress: '0x177D46255772A8e0387Ad49Ca3A9CDa0E36d95B8', // ToDo: Replace with constant.
      inputTokenAddress: '0x06325440D014e39736583c165C2963BA99fAf14E', // ToDo: Replace with constant.
      inputTokenGetLink: 'https://curve.fi/steth/deposit',
    ...
    [poolAddresses[ChainId.MAINNET].FEI_TRIBE_LP]: {
      ...
      gaugeAddress: '0xBc4f73ee11aD575f673fC57Dab51134f983FC1eF', // ToDo: Replace with constant.
    ...
    [poolAddresses[ChainId.MAINNET].SUSHI_DOUBLE_ETH_ALCHEMIX_LP]: {
      ...
      gaugeAddress: '0x69Eb3e119aee91c604c39d2F2b092b17A88500f0', // ToDo: Replace with constant.
      inputTokenGetLink:
    ...
    [poolAddresses[ChainId.MAINNET].SUSHI_DOUBLE_ETH_CONVEX_LP]: {
      ...
      gaugeAddress: '0xf1d2A7B230876eb84164Db9cE942b84AA0BEa30F', // ToDo: Replace with constant.
    ...
    [poolAddresses[ChainId.MAINNET].SUSHI_DOUBLE_ETH_PICKLE_LP]: {
      ...
      gaugeAddress: '0x55283f4c22e3fA912A92abE6BaEED9BAe371BCe7', // ToDo: Replace with constant.
  ...
  [ChainId.MATIC]: {
    [poolAddresses[ChainId.MATIC].CURVE_AM_THREE_CRV]: {
      ...
      zapperAppId: undefined,

      gaugeAddress: '0x5D69fc63204423c980a998ed033e07c2B79B42BC', // ToDo: Replace with constant.
      inputTokenAddress: '0xE7a24EF0C5e95Ffb0f6684b813A78F2a3AD7D171', // ToDo: Replace with constant.
      inputTokenGetLink: 'https://polygon.curve.fi/aave/deposit',
    ...
    [poolAddresses[ChainId.MATIC].CURVE_REN_BTC]: {
      ...
      gaugeAddress: '0x0090fD3D72b5d89dDe68426bF250b4C039cF78ca', // ToDo: Replace with constant.
      inputTokenAddress: '0xf8a57c1d3b9629b77b6726a042ca48990A84Fb49', // ToDo: Replace with constant.
      inputTokenGetLink: 'https://polygon.curve.fi/ren/deposit',
      strategyAddress: '0x9B2dA857A28AD376A3352b4282e60566bAb29710', // ToDo: Replace with constant.
    },
    [poolAddresses[ChainId.MATIC].QUICKSWAP_DAI_USDC_LP]: {
      ...
      gaugeAddress: '0x1fbC9C9fC7f1A6F0D790CE2a62e11d6ba293B76a', // ToDo: Replace with constant.
    ...
    [poolAddresses[ChainId.MATIC].QUICKSWAP_USDC_USDT_LP]: {
      ...
      gaugeAddress: '0x1D8c2e54e235A54b0E6d10060B2E8822f9975E23', // ToDo: Replace with constant.
    ...
    [poolAddresses[ChainId.MATIC].QUICKSWAP_MIMATIC_USDC_LP]: {
      ...
      gaugeAddress: '0x6Bc26F93bA8291dAb59Ecb12fB007100Ae750c72', // ToDo: Replace with constant.
    ...
    [poolAddresses[ChainId.MATIC].QUICKSWAP_WBTC_ETH_LP]: {
      ...
      gaugeAddress: '0xf8e22Ab62C98dd61E2F129b6d6561f4057730727', // ToDo: Replace with constant.
    ...
    [poolAddresses[ChainId.MATIC].QUICKSWAP_WMATIC_ETH_LP]: {
      ...
      gaugeAddress: '0x5b29Dbf2CE628AfaEA743209cb429A65E89545F4', // ToDo: Replace with constant.
