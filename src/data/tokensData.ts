...
const tokensData = {
  ...
  [tokenAddresses[ChainId.MAINNET].CURVE_LP_THREE_CRV]: {
    address: tokenAddresses[ChainId.MAINNET].CURVE_LP_THREE_CRV,
    chainId: ChainId.MAINNET,
  ...
  [tokenAddresses[ChainId.MAINNET].SUSHISWAP_CONVEX_ETH_LPT]: {
    address: tokenAddresses[ChainId.MAINNET].SUSHISWAP_CONVEX_ETH_LPT,
    chainId: ChainId.MAINNET,
